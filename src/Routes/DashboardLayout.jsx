                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <a href="https://flowbite.com/" className="flex items-center pl-2.5 mb-5">
                                ...
                                <span
                                    className="font-extrabold lg:text-3xl text-xl text-center text-transparent bg-gradient-to-r bg-clip-text from-pink-500 to-sky-500 self-center whitespace-nowrap">DASHBOARD</span>
                            </a>
