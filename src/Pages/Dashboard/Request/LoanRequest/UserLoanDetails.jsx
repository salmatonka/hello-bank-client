...
const UserLoanDetails = () => {
    useTitle('UserLoanDetails')
    const navigation = useNavigation();

    const { id } = useParams();
    const [detail, setDetail] = useState([]);
    useEffect(() => {
        fetch(`https://hello-bank-server.vercel.app/singleLoanDetails/${id}`)
            .then((res) => res.json())
    ...
    return (
        <div className="w-5/6 mx-auto px-4 py-8 text-gray-400">
            <div className="flex flex-col space-y-6">
                ...
                <div className="grid grid-cols-2 gap-8">
                    <div>
                        ...
                        <p className="text-lg font-medium">{detail?.accountNumber}</p>
                    </div>
                    <div>
