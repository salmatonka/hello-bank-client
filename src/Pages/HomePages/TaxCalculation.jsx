            ...
            <div className="container grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
                ...
                <div className="w-full px-6 py-14 rounded-md sm:px-12 md:px-16 xl:col-span-3 dark:bg-gray-900">
                    ...
                    <form
                        ...
                        noVlidate="" action="" className="self-stretch space-y-3">
                        <div>
                            <label htmlFor="salary" className="text-sm sr-only">Your Salary</label>
                        ...
                        <div>
                            <label htmlFor="result" className="text-sm sr-only">Email address</label>
